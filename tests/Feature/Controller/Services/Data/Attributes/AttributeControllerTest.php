...
namespace Tests\Feature\Controller\Services\Data\Attributes;
...
class AttributeControllerTest extends TestCase
{
    ...
    public function a_user_can_not_see_things_from_a_different_user()
    {
        ...
        $this->a_user_can_not_see_models_from_a_different_user(['attribute' => $modelOfADifferentUser->id]);
    }
    ...
    public function a_user_can_see_the_show_view()
    {
        ...
        $this->getShowViewResponse(['attribute' => $model->id])
    ...
    public function a_user_can_see_the_edit_view()
    {
        ...
        $this->getEditViewResponse(['attribute' => $model->id])
    ...
    public function a_user_can_update_a_model()
    {
        ...
        $response = $this->put(route($this->baseRouteName . '.update', ['attribute' => $model->id]), $data)
    ...
    public function a_user_can_delete_a_model()
    {
        ...
        $this->deleteModel($model, ['attribute' => $model->id])
            ->assertRedirect();
    }
}
