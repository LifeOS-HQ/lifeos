...
namespace Tests\Feature\Controller\Services\Data;
...
{
    protected $baseRouteName = 'type';
    protected $baseViewPath = 'type';
    protected $className = Type::class;
    ...
    public function a_user_can_not_see_things_from_a_different_user()
    {
        ...
        $this->a_user_can_not_see_models_from_a_different_user(['type' => $modelOfADifferentUser->id]);
    }
    ...
    public function a_user_can_see_the_show_view()
    {
        ...
        $this->getShowViewResponse(['type' => $model->id])
    ...
    public function a_user_can_see_the_edit_view()
    {
        ...
        $this->getEditViewResponse(['type' => $model->id])
    ...
    public function a_user_can_update_a_model()
    {
        ...
        $response = $this->put(route($this->baseRouteName . '.update', ['type' => $model->id]), $data)
    ...
    public function a_user_can_delete_a_model()
    {
        ...
        $this->deleteModel($model, ['type' => $model->id])
            ->assertRedirect();
    }
}
