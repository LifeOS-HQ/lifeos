...
namespace Tests\Feature\Controller\Diet\Foods;
...
class PackagingControllerTest extends TestCase
{
    protected $baseRouteName = 'packaging';
    protected $baseViewPath = 'packaging';
    protected $className = Packaging::class;
    ...
    public function a_user_can_not_see_things_from_a_different_user()
    {
        ...
        $this->a_user_can_not_see_models_from_a_different_user(['packaging' => $modelOfADifferentUser->id]);
    }
    ...
    public function a_user_can_see_the_show_view()
    {
        ...
        $this->getShowViewResponse(['packaging' => $model->id])
    ...
    public function a_user_can_see_the_edit_view()
    {
        ...
        $this->getEditViewResponse(['packaging' => $model->id])
    ...
    public function a_user_can_update_a_model()
    {
        ...
        $response = $this->put(route($this->baseRouteName . '.update', ['packaging' => $model->id]), $data)
    ...
    public function a_user_can_delete_a_model()
    {
        ...
        $this->deleteModel($model, ['packaging' => $model->id])
            ->assertRedirect();
    }
}
