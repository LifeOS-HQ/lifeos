...
namespace Tests\Feature\Controller\Workouts\Exercises;

use App\Workouts\Workout;
...
{
    protected $baseRouteName = 'workout';
    protected $baseViewPath = 'workout';
    protected $className = Workout::class;
    ...
    public function a_user_can_not_see_things_from_a_different_user()
    {
        ...
        $this->a_user_can_not_see_models_from_a_different_user(['workout' => $modelOfADifferentUser->id]);
    }
    ...
    public function a_user_can_see_the_show_view()
    {
        ...
        $this->getShowViewResponse(['workout' => $model->id])
    ...
    public function a_user_can_see_the_edit_view()
    {
        ...
        $this->getEditViewResponse(['workout' => $model->id])
    ...
    public function a_user_can_update_a_model()
    {
        ...
        $response = $this->put(route($this->baseRouteName . '.update', ['workout' => $model->id]), $data)
    ...
    public function a_user_can_delete_a_model()
    {
        ...
        $this->deleteModel($model, ['workout' => $model->id])
            ->assertRedirect();
    }
}
