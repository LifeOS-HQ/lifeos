...
class HistoryControllerTest extends TestCase
{
    ...
    public function a_user_can_not_see_things_from_a_different_user()
    {
        ...
        $this->a_user_can_not_see_models_from_a_different_user(['history' => $modelOfADifferentUser->id]);
    }
    ...
    public function a_user_can_see_the_show_view()
    {
        ...
        $this->getShowViewResponse(['history' => $model->id])
    ...
    public function a_user_can_see_the_edit_view()
    {
        ...
        $this->getEditViewResponse(['history' => $model->id])
    ...
    public function a_user_can_update_a_model()
    {
        ...
        $response = $this->put(route($this->baseRouteName . '.update', ['history' => $model->id]), $data)
    ...
    public function a_user_can_delete_a_model()
    {
        ...
        $this->deleteModel($model, ['history' => $model->id])
            ->assertRedirect();
    }
}
