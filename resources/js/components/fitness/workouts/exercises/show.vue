<template>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <workouts-exercises-sets-table :index-path="item.sets_index_path" :model="item"></workouts-exercises-sets-table>
...
<script>
    import workoutsExercisesSetsTable from './sets/table.vue';

    export default {

        components: {
            workoutsExercisesSetsTable,
        },
